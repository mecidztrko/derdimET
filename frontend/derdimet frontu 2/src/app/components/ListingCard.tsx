  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-muted">
        ...
        <button
          className={cn(
            'absolute top-3 right-3 size-9 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center transition-all hover:bg-white',
        ...
        <div className="flex items-end justify-between pt-3 border-t border-border">
          <div>
            ...
            <p className="font-mono font-medium text-foreground">
              {price}<span className="text-small text-muted-foreground"> / {unit}</span>
            </p>
          </div>
