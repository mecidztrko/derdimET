...
import { Search, Bell, User, Menu, Home, Package, TrendingUp, Eye, MessageCircle, Settings } from 'lucide-react';
import { Button } from '../components/Button';
import { RolePill } from '../components/RolePill';
import { cn } from '../../lib/utils';

const navigation = [
  { name: 'Pazar Durumu', href: '/seller', icon: Home, end: true },
  { name: 'İlanlarım', href: '/seller/listings', icon: Package },
  { name: 'Teklifler', href: '/seller/offers', icon: TrendingUp },
  { name: 'İncele', href: '/seller/browse', icon: Eye },
  { name: 'Mesajlar', href: '/seller/messages', icon: MessageCircle },
  { name: 'Profil & Ayarlar', href: '/seller/settings', icon: Settings },
];
        ...
        <div className="max-w-[1440px] mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex-1 max-w-xl mx-8 hidden md:block">
            <div className="relative">
              ...
              <input
                type="search"
                placeholder="Hayvan ilanları ara..."
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex items-center gap-3 ml-2 pl-2 border-l border-border">
              <div className="text-right">
                <p className="text-small font-medium">Ahmet Çiftçi</p>
                <RolePill role="ANIMAL_SELLER" className="mt-0.5" />
              </div>
              <div className="size-8 rounded-full bg-secondary/20 flex items-center justify-center">
                <span className="text-caption font-medium text-secondary">AÇ</span>
              </div>
            </div>
          </div>
        </div>
