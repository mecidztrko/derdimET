    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers(
                        ...
                        .authenticated()
                        .requestMatchers("/api/me/notifications/**", "/api/me/business-verification/**")
                        .authenticated()
                        .requestMatchers("/api/reviews")
                        .authenticated()
                        .requestMatchers("/api/users/*/reviews", "/api/users/*/reviews/**")
                        .authenticated()
                        .requestMatchers("/api/auth/password/change")
                        .authenticated()
                        .anyRequest()
                        .permitAll())
